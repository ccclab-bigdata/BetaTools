...
% sampleStart = zNew(1,run2idx(1)).CerebusTimeStart;
% sampleStop = zNew(1,run2idx(end)).CerebusTimeStop;
sampleStart = zNew(1,150).CerebusTimeStart;
sampleStop = zNew(1,175).CerebusTimeStop;
% meanSnorm = [];
% for i=28 %just get representative values
%     disp(i);
