...
%           .b - coefficients of the numerator of the filter transfer
%                function
%           .a - coefficients of the denominator of the filter transfer
%                function (recommend using FIR filters; that is, a = 1 to
%                prevent accumulation of rounding errors in long signals)
...
%            manually)
%        .useOnlyTrials = 1 if only epochs during trials are to be
%            evaluated; 0 if full signal should be used
